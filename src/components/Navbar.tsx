...
const Navbar: React.FC = () => {
    ...
    const navLinks = [
        { href: '#', label: 'Flights', iconOutlined: flightsIconOutlinedImg, iconFilled: flightsIconFilledImg },
        { href: '#', label: 'Hotels', iconOutlined: hotelsIconOutlinedImg, iconFilled: hotelsIconFilledImg },
            ...
            <div className="flex items-center justify-between">
                ...
                <ul className="hidden md:flex items-center space-x-8 text-gray-700 font-medium">
                    {navLinks.map((link) => (
                        ...
                        >
                            <a href={link.href} className="flex items-center space-x-1 hover:text-teal-500 transition-colors">
                                <img 
                ...
                <div className="hidden md:flex items-center space-x-2">
                    <a href="#" className="px-5 py-2 text-teal-500 border border-teal-400 rounded-full hover:bg-teal-50 transition-colors">Log In</a>
                    <a href="#" className="px-5 py-2 text-white bg-teal-500 rounded-full hover:bg-teal-600 transition-colors">Sign Up</a>
                </div>
            </div>
        </nav>
    );
